...
public class CountryDAO implements ICountryDAO {
    ...
    private static final String INSERT_COUNTRY_SQL = "INSERT INTO `demo2`.`country` (`id`, `name`) VALUES (?, ? )";
    private static final String SELECT_COUNTRY_BY_ID = "select id ,name from country where id =?";
    private static final String SELECT_ALL_COUNTRY = "SELECT * FROM demo2.country;";
    private static final String DELETE_COUNTRY_SQL = "delete from country where id = ?;";
    private static final String UPDATE_COUNTRY_SQL = "UPDATE `demo2`.`country` SET `id` = ?, `name` = ? WHERE (`id` = ?)";
