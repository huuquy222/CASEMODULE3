                                ...
                                <table class="table m-0" style="text-align: center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/users?action=delete&id=${user.id}" onclick="return confirm('Bạn có muốn xóa người dùng này?')"><i class="fa-regular fa-trash-can"></i> </a>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
